...
const AppRoutes: React.FC = () => {
  ...
  return (
    <Routes>
      <Route path="/" element={token ? <Navigate to={ROUTES.PROTECTED.DASHBOARD} replace /> : <LandingPage />} />
      <Route path={ROUTES.PUBLIC.LOGIN} element={token ? <Navigate to={ROUTES.PROTECTED.DASHBOARD} replace /> : <LoginPage />} />
      <Route path={ROUTES.PUBLIC.REGISTER} element={token ? <Navigate to={ROUTES.PROTECTED.DASHBOARD} replace /> : <RegisterPage />} />
